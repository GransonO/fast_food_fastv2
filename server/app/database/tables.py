class SqlTables():
    ...
    orders_table = "CREATE TABLE orders_tbl ( id REAL, order_date TIMESTAMP,  order_id TEXT PRIMARY KEY, order_detail TEXT, order_amount REAL, order_from TEXT, order_to TEXT, order_status TEXT,status_changed TIMESTAMP)"
    ...
    test_orders_table = "CREATE TABLE orders_tbl ( id REAL, order_date TIMESTAMP,  order_id TEXT PRIMARY KEY, order_detail TEXT, order_amount REAL, order_from TEXT, order_to TEXT, order_status TEXT,status_changed TIMESTAMP)"
