class SqlTables():
    ...
    comments_table = "CREATE TABLE comments_table (id REAL, customer_id TEXT, comment TEXT, posting_date TIMESTAMP, response TEXT, response_date TIMESTAMP)"
 
    production_database_tables = [items_tables,vendors_table,orders_table,customer_tables,comments_table]

    #Tests tables
    test_items_tables = "CREATE TABLE administrator_items ( id REAL, item_name TEXT, details TEXT, price REAL, image_url TEXT, item_id TEXT, vendor_id TEXT, category TEXT)"
    ...
    test_comments_table = "CREATE TABLE comments_table (id REAL, customer_id TEXT, comment TEXT, posting_date TIMESTAMP, response TEXT, response_date TIMESTAMP)"
 
    test_database_tables = [test_items_tables,test_vendors_table,test_orders_table,test_customer_tables,test_comments_table]

    database_tables_names = ['administrator_items','administrator_registrations','orders_tbl','customer_registration','comments_table']